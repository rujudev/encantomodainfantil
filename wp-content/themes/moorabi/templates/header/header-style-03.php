...
$phone_text = Moorabi_Functions::moorabi_get_option('phone_text');
                ...
                <div class="header-nav">
                    <div class="container">
                        <div class="header-nav-inner">
                            <?php moorabi_header_vertical(); ?>
                            <div class="header-search-wrap">
                                <div class="header-search">
                                    <?php moorabi_search_form(); ?>
                                </div>
                            </div>
                            <?php if ($phone_number && $phone_text) {
                                $tel = str_replace(' ', '', $phone_number); ?>
                                <div class="header-phone">
                                    <div class="phone">
                                        <span class="phone-text"><?php echo esc_html($phone_text); ?></span>
