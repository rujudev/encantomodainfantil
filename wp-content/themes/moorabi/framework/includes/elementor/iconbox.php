<?php
if (!class_exists('Moorabi_Elementor_Iconbox')) {
    class Moorabi_Elementor_Iconbox extends Moorabi_Elementor
    {
        public $name = 'iconbox';
        public $title = 'Iconbox';
        public $icon = 'moorabi-elementor-icon eicon-icon-box';
        ...
        protected function register_controls()
        {
            ...
            $this->add_control(
                'color', [
                    ...
                    'default' => '#71c0ef',
                    'selectors' => [
                        '{{WRAPPER}} .moorabi-iconbox.style-01, {{WRAPPER}} .moorabi-iconbox.style-02 .icon' => 'background-color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
        ...
        protected function render()
        {
            ...
            $css_class = array('moorabi-iconbox');
            ...
            <div class="<?php echo esc_attr(implode(' ', $css_class)); ?>">
                <div class="iconbox-inner">
                    ...
                    <?php elseif ($atts['type'] == 'media' && $atts['media']): ?>
                        <div class="icon">
