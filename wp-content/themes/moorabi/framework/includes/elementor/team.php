<?php
if (!class_exists('Moorabi_Elementor_Team')) {
    class Moorabi_Elementor_Team extends Moorabi_Elementor
    {
        public $name = 'team';
        public $title = 'Team';
        public $icon = 'moorabi-elementor-icon eicon-person';
        ...
        protected function register_controls()
        {
            ...
            $repeater->add_control(
                'link_facebook', [
                    'label' => esc_html__('Link Facebook', 'moorabi'),
            ...
            $repeater->add_control(
                'link_twitter', [
                    'label' => esc_html__('Link Twitter', 'moorabi'),
                    'type' => \Elementor\Controls_Manager::URL,
                    'default' => [
                        'url' => '',
                        'is_external' => true,
            ...
            $repeater->add_control(
                'link_instagram', [
                    'label' => esc_html__('Link Instagram', 'moorabi'),
                    'type' => \Elementor\Controls_Manager::URL,
                    'default' => [
                        'url' => '',
                        'is_external' => true,
        ...
        protected function render()
        {
            ...
            $css_class = array('moorabi-team');
            $css_class[] = $atts['style'];
            $list_class = array();
            $item_class = array('team-item');
            $owl_settings = '';
            if ($atts['layout'] == 'grid') {
                $list_class[] = 'team-list-grid row auto-clear equal-container better-height ';
            ...
            if ($atts['layout'] == 'carousel') {
                $list_class[] = 'team-list-owl owl-slick equal-container better-height';
                ...
                <?php if ($atts['list']) { ?>
                    <div class="<?php echo esc_attr(implode(' ', $list_class)); ?>" <?php echo esc_attr($owl_settings); ?>>
                        <?php foreach ($atts['list'] as $list):
                            $target_facebook = !empty($list['link_facebook']['is_external']) ? '_blank' : '_self';
                            $target_twitter = !empty($list['link_twitter']['is_external']) ? '_blank' : '_self';
                            $target_instagram = !empty($list['link_instagram']['is_external']) ? '_blank' : '_self'; ?>
                                    ...
                                    <?php if ($list['avatar']) : ?>
                                        <div class="thumb-avatar">
                                            ...
                                            <div class="social-list">
                                                <?php if ($list['link_facebook']['url']):?>
                                                    <a href="<?php echo esc_url($list['link_facebook']['url']) ?>"
                                                       target="<?php echo esc_attr($target_facebook); ?>">
                                                        <span class="fa fa-facebook"></span>
                                                    </a>
                                                <?php endif; ?>
                                                <?php if ($list['link_twitter']['url']):?>
                                                    <a href="<?php echo esc_url($list['link_twitter']['url']) ?>"
                                                       target="<?php echo esc_attr($target_twitter); ?>">
                                                        <span class="fa fa-twitter"></span>
                                                    </a>
                                                <?php endif; ?>
                                                <?php if ($list['link_instagram']['url']):?>
                                                    <a href="<?php echo esc_url($list['link_instagram']['url']) ?>"
                                                       target="<?php echo esc_attr($target_instagram); ?>">
