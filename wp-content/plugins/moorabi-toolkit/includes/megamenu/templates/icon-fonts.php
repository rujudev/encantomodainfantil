 ...
 * Default Icons
 */
if (!function_exists('moorabi_megamenu_font_icons')) {
    function moorabi_megamenu_font_icons()
    {
        $dashicons    = array(
        ...
        $custom_font  = apply_filters('moorabi_menu_icons_setting', array());
        if (!empty($custom_font)) {
            $icons[] = array(
                'title' => esc_html__('Fonts Custom', 'moorabi-toolkit'),
                'icons' => $custom_font,
            );
        }
