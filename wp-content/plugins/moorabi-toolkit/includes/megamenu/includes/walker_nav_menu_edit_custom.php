...
if (!class_exists('Walker_Nav_Menu_Edit_Custom')) {
    class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu
    {
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
        {
            ...
            $settings_class = '';
            $button         = '';
            $settings       = get_post_meta($item_id, '_moorabi_menu_settings', true);
            $settings       = wp_parse_args($settings, Moorabi_Megamenu::$defaults);
            if (!empty($settings)) {
            ...
            $button .= "<span id='moorabi-menu-item-settings-{$item_id}' data-item_id='{$item_id}' ";
            $button .= "data-item_id='{$item_id}' ";
            $button .= "data-item_title='{$title}' ";
            $button .= "class='moorabi-menu-settings button button-small {$settings_class}'>";
            $button .= __('Settings');
            $button .= "</span>";
            ?>
